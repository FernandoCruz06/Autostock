...
public class container extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationView4 = findViewById(R.id.animationViewNew);
        ...
        loadFragment(new fragment_inventory());
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_users:
                        ...
                        if (animationView4.isAnimating()) {
                            animationView4.cancelAnimation();
                        } else {
                            animationView4.setRepeatCount(0);
                            animationView4.playAnimation();
                        }
                        return true;

                    case R.id.menu_category:
                        loadFragment(new fragment_category());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_herramientasD:
                Intent intent = new Intent(container.this, containerTools.class);
                startActivity(intent);
                drawerLayout.closeDrawer(GravityCompat.START);
                return true;

            case R.id.menu_perfilD:
                Intent intent1 = new Intent(container.this, container_profile.class);
            ...
            case R.id.menu_signout:
                ...
                Intent intent3 = new Intent(container.this, LoginActivity.class);
