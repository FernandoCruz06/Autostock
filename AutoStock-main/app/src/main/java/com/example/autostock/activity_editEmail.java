...
public class activity_editEmail extends AppCompatActivity {

    private static final String PASSWORD_RESET_URL1 = "http://192.168.43.234/android_autostock/userUpdate_Email.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passwordEditText = findViewById(R.id.idETsave);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, PASSWORD_RESET_URL1,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            User_data.putString(KEY_EMAIL, emailEditText.getText().toString());
                            User_data.commit();
                            User_data.apply();

                            Toast.makeText(activity_editEmail.this, "Se han actualizado los datos exitosamente", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(activity_editEmail.this, container_profile.class);
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(activity_editEmail.this, "Contraseña no valida", Toast.LENGTH_SHORT).show();
                        }
                    }) {
                @Override
